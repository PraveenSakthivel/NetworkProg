...
int main(int argc, char **argv)
{
    ...
    filefd = open(PROXY_LOG,O_WRONLY);
	int flag = 1;
  	int pid = 0;
	...
	setsockopt(connfd, IPPROTO_TCP, TCP_NODELAY, (char *) &flag, sizeof(int));
        ...
        */ 
        ...
        printf("Unable to open client server");
	free(request);
        break;
        }
	int flag2 = 1;
	setsockopt(serverfd, IPPROTO_TCP, TCP_NODELAY, (char *) &flag2, sizeof(int));
